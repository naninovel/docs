...
s(`@fooCommand primaryParameterValue`);
s(`@cmd paramId:paramValue`);
s(`@cmd primaryParamValue paramId:paramValue`);
s(`@cmd primaryParamValue x:foo y:bar z:baz`);
...
s(`Author/Id: Lorem ipsum.`);
s(`AuthorId.Appearance/One,Appearance-Two+Three>Four: Lorem ipsum.`);
s(`AuthorId:Lorem ipsum.`);
