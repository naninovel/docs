...
test("nameless parameter value of if command is expression", snap(`@if expression`));
test("nameless parameter value of if inlined command is expression", snap(`[if expression]`));
test("nameless parameter value of unless command is expression", snap(`@unless expression`));
test("nameless parameter value of unless inlined command is expression", snap(`[unless expression]`));
test("nameless parameter value of while command is expression", snap(`@while expression`));
test("nameless parameter value of set command is expression", snap(`@set expression`));
