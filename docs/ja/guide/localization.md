...
::: tip
`Resources` フォルダーを使用する代わりに、別のリソースプロバイダーを選択できます。たとえば、[Addressable](/ja/guide/resource-providers#addressable) を使用すると、ロケール固有のリソースをメインゲームパッケージとは独立してバンドルし、オンデマンドでダウンロードできます。
:::
