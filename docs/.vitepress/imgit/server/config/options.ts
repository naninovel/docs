...
export type AssetResolver = (asset: CapturedAsset) => ResolvedAsset | Promise<ResolvedAsset> | null;
...
export type AssetBuilder = (asset: EncodedAsset, merges?: EncodedAsset[]) => string | Promise<string> | null;
...
export type AssetServer = (path: string, asset: EncodedAsset) => string | Promise<string> | null;
