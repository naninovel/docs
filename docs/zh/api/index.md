...
~~Strikethrough~~ indicates a nameless parameter, and **bold** stands for required parameter; other parameters should be considered optional. Consult [naninovel scripts guide](/guide/scenario-scripting) in case you have no idea what's this all about.
...
| transition | string | Type of the [transition effect](/guide/special-effects#transition-effects) to use (crossfade is used by default). |
