...
- Removed `IScriptPlayer.PlayTransient` method; use `IScriptManager.AddTransient` instead which allows the transient scripts to function as actual script assets.
