...
- `2025-02-14` Fixed ranges of the region folds in VS Code interrupted by comment lines and indents.
- `2025-02-14` Fixed ranges of the indent folds in VS Code interrupted by empty lines.
