...
When importing the package to a project with Naninovel version `1.16` or older first follow [v1.17 release](/releases/1.17) upgrade guide, then continue with the following instructions:
