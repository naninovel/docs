...
|:-------:|:-------:|:-------------------------------------:|:-----------------------------------------------------:|:-----------------------------------------------------------------------------------------------------:|:-------------------------------------------:|
| `1.22`  |   TBA   | <span class="txt-warn">Preview</span> |                     `6.3`, `TBA`                      |         <button @click="copy" class="upm" title="https://github.com/naninovel/upm.git#1.22"/>         | [](https://pre.naninovel.com/releases/1.22) |
...
| `1.20`  | Q4 2024 |  <span class="txt-err">Final</span>   |                     `2022 - 6.0`                      |         <button @click="copy" class="upm" title="https://github.com/naninovel/upm.git#1.20"/>         |             [↗](/releases/1.20)             |
...
Changelogs for previous releases can be found on GitHub: [github.com/naninovel/docs/releases](https://github.com/naninovel/docs/releases)
