...
- `2026-06-26` Fixed nested [@await] block being skipped when playing it after a rollback performed while the block was executed.
- `2026-06-26` Fixed error when starting a new game with an empty actor record.
- `2026-06-27` Fixed UI focus issues when exiting closed modal UIs.
- `2026-06-27` Fixed delete save slot hotkey binding not working when entering save-load UI from title UI.
