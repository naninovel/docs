...
To invoke a C# behaviour (e.g., access a game object on scene), use [custom commands](/guide/custom-commands); to get a value from a C# method and use it in a scenario script, use [expression queries](/guide/expressions#adding-custom-queries).
